    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', base.models.LowerCharField(default='#178dff', max_length=7, null=True, validators=[django.core.validators.RegexValidator('^#[A-fa-f\\d]{6}$', 'color should be a hex value!')], verbose_name='color')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='base.post', verbose_name='article')),
